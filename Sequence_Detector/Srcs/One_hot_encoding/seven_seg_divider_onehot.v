...
module seven_seg_driver_onehot(
    input clk, rst,
    ...
    seven_seg_encoder_moore_onehot enc_moore_non(.state(state_moore_nonoverlap), .seg(seg_non_moore));
    seven_seg_encoder_moore_onehot enc_moore_ov(.state(state_moore_overlap), .seg(seg_ov_moore));
    seven_seg_encoder_mealy_onehot enc_mealy_non(.state(state_mealy_nonoverlap), .seg(seg_non_mealy));
    seven_seg_encoder_mealy_onehot enc_mealy_ov(.state(state_mealy_overlap), .seg(seg_ov_mealy));
